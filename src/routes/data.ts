...
export const exclusive_classes: Record<string, Record<string, Class>> = {
	...
	Céline: {
		Noble: {
			base_stats: [20, 4, 5, 8, 5, 8, 3, 5, 4],
			growth_rates: [0, 5, 10, 5, 5, 5, 10, 20, 0],
			max_stats: [56, 38, 37, 29, 41, 27, 35, 50, 11],
			is_base_class: true
		},
		Vidame: {
			base_stats: [21, 5, 6, 9, 6, 9, 4, 6, 5],
	...
	Alcryst: {
		Lord: {
			base_stats: [21, 5, 7, 1, 10, 7, 4, 3, 2],
			growth_rates: [10, 10, 0, 25, 10, 10, 0, 5, 0],
			max_stats: [68, 41, 20, 41, 40, 29, 19, 30, 15],
			is_base_class: true
		},
		'Tireur d\u2019\u00e9lite': {
			base_stats: [22, 6, 8, 1, 12, 8, 6, 4, 4],
	...
	Hortensia: {
		'Wing Tamer': {
			base_stats: [18, 4, 0, 5, 9, 8, 1, 11, 6],
			growth_rates: [0, 0, 15, 10, 10, 0, 25, 10, 0],
			max_stats: [47, 26, 39, 36, 45, 19, 51, 53, 11],
			is_base_class: true
		},
		'Sleipnir Rider': {
			base_stats: [18, 5, 1, 7, 10, 10, 2, 13, 8],
	...
	Fogado: {
		Sentinel: {
			base_stats: [21, 6, 5, 1, 9, 7, 4, 3, 2],
			growth_rates: [10, 5, 0, 15, 15, 5, 15, 0, 0],
			max_stats: [67, 35, 28, 33, 49, 28, 31, 33, 16],
			is_base_class: true
		},
		Cupido: {
			base_stats: [23, 7, 6, 3, 10, 8, 5, 5, 3],
